...
def main():
    ...
    if mode == "train":
        ...
        # get training data from data manager class 
        ...
        config.dataindexer_load_path = os.path.join(config.save_dir,
                                                    "baseline_siamese/00/baseline_siamese-00-DataManager.pkl")
    ...
    #change voca size in config instance
